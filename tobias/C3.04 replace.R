...
the_answer <- 
  rp_input %>%
  mutate(pid = str_replace(user_id_mixed, regex_find, regex_replace)) 

# TODO: replace NULL with an appropriate function call that uses `regex_find` and `regex_replace` above
