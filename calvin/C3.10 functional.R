...
f <- function(weight_kg, height_m) { # TODO: specify the names of the arguments for f
  a_bmi <- bmi(weight_kg, height_m)
  cat("weight:", weight_kg, "height:", height_m, "bmi:", a_bmi, "\n")
...
# 
# Your reflection:
# With the .l argument. It is a list of vectors, such as a data frame. The length of .l determines the number of arguments that .f will be called with.
# 
#-------------------------------------------------------------------------------
